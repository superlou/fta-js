...
if(!Pe(e,t))return f
function l(){c.forEach((function(e){return e()})),c=[]}return f.setOptions(n).then((function(e){!u&&n.onFirstUpdate&&n.onFirstUpdate(e)})),f}}var ke=Se(),De=Se({defaultModifiers:[oe,xe,ne,R,_e,ye,Ee,Q,Oe]}),Re=Se({defaultModifiers:[oe,xe,ne,R]})},969:(e,t,n)=>{function r(e){var t=e._promiseCallbacks
...
for(var Ae in a("instrument",!0),Te)Te.hasOwnProperty(Ae)&&xe(Ae,Te[Ae])}const je={asap:ie,cast:Oe,Promise:k,EventTarget:o,all:I,allSettled:W,race:G,hash:q,hashSettled:Y,rethrow:K,defer:z,denodeify:F,configure:a,on:xe,off:Ee,resolve:J,reject:Q,map:$,async:_e,filter:ne}},836:(e,t,n)=>{n.r(t),n.d(t,{default:()=>F})
